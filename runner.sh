...
echo -e "\tInput:\n./goattool -p sample_files/example_file.txt"
echo -e "\tExpected Output:\n"Contents of file: sample_files/example_file.txt""
...
echo -e "Input:\n./goattool -p sample_files/file1.txt file2.txt"
echo -e "Expected Output:"
echo -e "Contents of file: sample_files/file1.txt"
echo -e "Hello"
echo -e "====================="
echo -e "Contents of file: sample_files/file2.txt"
echo -e "World"
echo -e "Received Output:"
echo -e "$(./goattool -p sample_files/file1.txt sample_files/file2.txt)\n"
...
echo -e "Input: ./goattool -p sample_files/example_file.txt non_existent_file.txt"
echo -e "Expected Output:"
echo -e "Contents of file: sample_files/example_file.txt"
echo -e "This is an example file."
echo -e "====================="
echo -e "Error: The file 'non_existent_file.txt' does not exist."
echo -e "Received Output:"
echo -e "$(./goattool -p sample_files/example_file.txt non_existent_file.txt)\n"

echo -e "Tests for Operation 2: Search a file for a particular string\n"

echo -e "Test 6 - \n"
echo -e "example_file.txt: This is an example file."
echo -e "Input: ./goattool -s sample_files/example_file.txt example"
echo -e "Expected Output:"
echo -e "String found in file!"
echo -e "Line containing text: This is an example file."
echo -e "Received Output:"
echo -e "$(./goattool -s sample_files/example_file.txt example)\n"
echo -e "=====================\n"

echo -e "Test 7 - \n"
echo -e "example_file.txt: This is an example file."
echo -e "Input: ./goattool -s sample_files/example_file.txt string_not_in_file"
echo -e "Expected Output:"
echo -e "String 'string_not_in_file' not found in the file."
echo -e "Received Output:"
echo -e "$(./goattool -s sample_files/example_file.txt string_not_in_file)\n"
echo -e "=====================\n"
...
echo -e "Test 9 - \n"
echo -e "Input: ./goattool -s sample_files/example_file.txt"
echo -e "Expected Output:"
echo -e "Usage: ./goattool -s/--search <file> <string>"
echo -e "Received Output:"
echo -e "$(./goattool -s sample_files/example_file.txt)"
echo -e "=====================\n"
...
echo -e "Input: ./goattool -z sample_files/example_file.txt"
echo -e "Expected Output:"
echo -e "File: sample_files/example_file.txt, Size: 24 bytes"
echo -e "Received Output:"
echo -e "$(./goattool -z sample_files/example_file.txt)"
echo -e "=====================\n"
...
echo -e "Test 13 - \n"
echo -e "example_file.txt: This is an example file. (24 bytes in size)"
echo -e "Input: ./goattool -z sample_files/example_file.txt non_existent_file.txt"
echo -e "Expected Output:"
echo -e "Error getting file size.: No such file or directory"
echo -e "File: sample_files/example_file.txt, Size: 24 bytes"
echo -e "Received Output:"
echo -e "$(./goattool -z sample_files/example_file.txt non_existent_file.txt)"
echo -e "=====================\n"
...
echo -e "Input: ./goattool -z sample_files/file1.txt sample_files/file2.txt"
echo -e "Expected Output:"
echo -e "File: sample_files/file1.txt, Size: 5 bytes"
echo -e "File: sample_files/file2.txt, Size: 5 bytes"
echo -e "Received Output:"
echo -e "$(./goattool -z sample_files/file1.txt sample_files/file2.txt)"
echo -e "=====================\n"
...
echo -e "file1.txt: Hello"
echo -e "file2.txt: World"
echo -e "Input: ./goattool -m merged_file.txt sample_files/file1.txt sample_files/file2.txt"
echo -e "Expected Output:"
echo -e "merged_file.txt contents to be: \nHelloWorld || WorldHello (depending on thread chosen)"
echo -e "Received Output:"
echo -e "$(./goattool -m merged_file.txt sample_files/file1.txt sample_files/file2.txt)cat merged_file.txt"
...
echo -e "Test 20 - \n"
echo -e "empty.txt:"
echo -e "Input: ./goattool -m empty_merge.txt sample_files/empty.txt"
echo -e "Expected Output:"
echo -e "empty_merge.txt contents to be: (nothing at all)"
echo -e "Received Output: $(./goattool -m empty_merge.txt sample_files/empty.txt)"
...
echo -e "Test 21 - \n"
echo -e "example_file.txt: This is an example file."
echo -e "Input: ./goattool -c sample_files/example_file.txt"
echo -e "Expected Output:"
echo -e ".goat compression completed"
echo -e ".goat file: sample_files/example_file.goat"
echo -e "example.goat contents to be:"
echo -e "T1h1i1s1 i1s1 a1n1 e1x1a1m1p1l1e1 f1i1l1e1.1"
echo -e "Received Output:"
echo -e "$(./goattool -c sample_files/example_file.txt)"
echo -e "Contents of example_file.goat:"
echo -e "$(cat sample_files/example_file.goat)"
echo -e "=====================\n"
...
echo -e "Input: ./goattool -c sample_files/a_letters.txt"
echo -e "Expected Output:"
echo -e ".goat compression completed"
echo -e ".goat file: sample_files/a_letters.goat"
echo -e "a_letters.goat contents to be:"
echo -e "a12"
echo -e "Received Output:"
echo -e "$(./goattool -c sample_files/a_letters.txt)"
echo -e "Contents of a_letters.goat:"
echo -e "$(cat sample_files/a_letters.goat)"
echo -e "=====================\n"
...
echo -e "Input: ./goattool -c sample_files/lots_of_ab.txt"
echo -e "Expected Output:"
echo -e ".goat compression completed"
echo -e ".goat file: sample_files/lots_of_ab.goat"
echo -e "lots_of_ab.goat contents to be:"
echo -e "a8b3a5b9a1b1a11"
echo -e "Received Output:"
echo -e "$(./goattool -c sample_files/lots_of_ab.txt)"
echo -e "Contents of lots_of_ab.goat:"
echo -e "$(cat sample_files/lots_of_ab.goat)"
echo -e "=====================\n"
...
echo -e "Input: ./goattool -d sample_files/example_file.goat"
echo -e "Expected Output:"
echo -e "decompression saved into sample_files/example_file.goat.decompressed.txt"
echo -e "example_file.goat.decompressed.txt contents to be:"
echo -e "This is an example file."
echo -e "Received Output:"
echo -e "$(./goattool -d sample_files/example_file.goat)"
echo -e "cat sample_files/example_file.goat.decompressed.txt"
echo -e "$(cat sample_files/example_file.goat.decompressed.txt)"
echo -e "=====================\n"
...
echo -e "Input: ./goattool -d sample_files/lots_of_ab.goat"
echo -e "Expected Output:"
...
echo -e "Received Output:"
echo -e "$(./goattool -d sample_files/lots_of_ab.goat)"
echo -e "cat sample_files/lots_of_ab.goat.decompressed.txt"
echo -e "$(cat sample_files/lots_of_ab.goat.decompressed.txt)"
echo -e "=====================\n"
...
echo -e "Input: ./goattool -rwx sample_files/example_file.txt"
echo -e "Expected Output:"
echo -e "File: sample_files/example_file.txt, Permissions: 644"
echo -e "Received Output:"
echo -e "$(./goattool -rwx sample_files/example_file.txt)"
echo -e "=====================\n"
...
echo -e "Input: ./goattool -rwx sample_files/file1.txt sample_files/file2.txt"
echo -e "Expected Output:"
echo -e "File: sample_files/file1.txt, Permissions: 644"
echo -e "File: sample_files/file2.txt, Permissions: 644"
echo -e "Received Output:"
echo -e "$(./goattool -rwx sample_files/file1.txt sample_files/file2.txt)"
echo -e "=====================\n"

echo -e "Test 35 - \n"
echo -e "file1.txt (Permissions 644): Hello"
echo -e "file2.txt (Permissions 644): World"
echo -e "Input: ./goattool -rwx sample_files/file1.txt sample_files/file2.txt non_existent_file.txt"
echo -e "Expected Output:"
echo -e "Error getting file permissions: No such file or directory"
echo -e "File: sample_files/file1.txt, Permissions: 644"
echo -e "File: sample_files/file2.txt, Permissions: 644"
echo -e "Received Output:"
echo -e "$(./goattool -rwx sample_files/file1.txt sample_files/file2.txt non_existent_file.txt)"
echo -e "=====================\n"
...
echo -e "Input: ./goattool -mv source_file.txt sample_files/renamed_file.txt"
echo -e "Expected Output:"
echo -e "File moved successfully from source_file.txt to sample_files/renamed_file.txt"
echo -e "Received Output:"
echo -e "$(./goattool -mv source_file.txt sample_files/renamed_file.txt)"
echo -e "=====================\n"
...
echo -e "Test 38 - \n"
echo -e "Input: ./goattool -mv sample_files/example.txt non_existent_folder/renamed.txt"
echo -e "Expected Output:"
echo -e "Error moving file: No such file or directory"
echo -e "Received Output:"
